...
namespace PABLO
{
    class cls_DirectionIndicator : InstrumentControl
    {
        #region Fields
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(PABLO.Properties.Resources.DirectionIndicator_Background);
        Bitmap bmpNeedle = new Bitmap(PABLO.Properties.Resources.DirectionNeedle);
        ...
        protected override void OnPaint(PaintEventArgs pe)
        {
            ...
            //double alphaNeedle = InterpolPhyToAngle(verticalSpeed, -6000, 6000, 180, 360+180);
            double alphaNeedle = InterpolPhyToAngle(verticalSpeed, -2100, 2100, 180, 360 + 180);
