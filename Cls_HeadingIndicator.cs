...
namespace PABLO
{
    class cls_HeadingIndicator : InstrumentControl
    {
        #region Fields
        ...
        Bitmap bmpCadran = new Bitmap(PABLO.Properties.Resources.HeadingIndicator_Background);
        Bitmap bmpHedingWeel = new Bitmap(PABLO.Properties.Resources.HeadingWeel);
        Bitmap bmpAircaft = new Bitmap(PABLO.Properties.Resources.HeadingIndicator_Aircraft);        
