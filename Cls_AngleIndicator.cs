...
namespace PABLO
{
    class cls_AngleIndicator : InstrumentControl
    {
        #region Fields
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(PABLO.Properties.Resources.AngleIndicator_Background);
        ...
        //    double alphaNeedle = InterpolPhyToAngle(verticalSpeed, -2100, 2100, 180, 360 + 180);
            double alphaNeedle = InterpolPhyToAngle(verticalSpeed, -180, 180, 180, 360 + 180);
