...
namespace PABLO
{
    ...
    public partial class frm_main : Form
    {
        ...
        // correcton du cap en fonction de l'angle et de la vitesse
        // de 0 à 18 = 19 
        // de 0 à 20 = 21 ( +1 au cas ou )

        int[,] Tnavigateur = new int[19, 22]
        { // vitesse nulle (0) ------------------------> à vitesse max (20)
       //   0  100  200            500  600       800       1000                          1500                          2000
        { 100, 100, 100, 100,  80,  50,  50,  50,  50,  50,   50,   50,   50,   50,   50,   50,   50,   50,   50,   50,   50,   50},    //  angle =  0°  à   9°
        { 200, 200, 200, 200, 100, 100, 100, 100, 100, 100,  100,  100,  100,  100,  100,  100,  100,  100,  100,  100,  100,  100},    //  angle = 10°  à   19°
        { 300, 300, 300, 300, 200, 200, 200, 200, 200, 200,  200,  200,  200,  200,  200,  200,  200,  200,  200,  200,  200,  200},    //  angle = 20°  à   29°
        { 400, 400, 400, 400, 300, 300, 300, 300, 300, 300,  300,  300,  300,  300,  300,  300,  300,  300,  300,  300,  300,  300},    //  angle = 30°  à   39°
        { 500, 500, 500, 500, 500, 500, 500, 500, 500, 500,  500,  500,  500,  500,  500,  500,  500,  500,  500,  500,  500,  500},    //  angle = 40°  à   49°
        { 500, 500, 500, 500, 500, 500, 600, 700, 800, 900, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000},    //  angle = 50°  à   59°
        { 500, 500, 500, 500, 500, 500, 600, 700, 800, 900, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000},    //  angle = 60°  à   69°
        { 500, 500, 500, 500, 500, 500, 600, 700, 800, 900, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000},    //  angle = 70°  à   79°
        { 500, 500, 500, 500, 500, 500, 600, 700, 800, 900, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000},    //  angle = 80°  à   89°
        { 500, 500, 500, 500, 500, 500, 600, 700, 800, 900, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000},    //  angle = 90°  à   99°
        { 500, 500, 500, 500, 500, 500, 600, 700, 800, 900, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000},    //  angle = 100°  à  109°
        { 500, 500, 500, 500, 500, 500, 600, 700, 800, 900, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000},    //  angle = 110°  à   119°
        { 500, 500, 500, 500, 500, 500, 600, 700, 800, 900, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000},    //  angle = 120°  à   129°
        { 500, 500, 500, 500, 500, 500, 600, 700, 800, 900, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000},    //  angle = 130°  à   139°
        { 500, 500, 500, 500, 500, 500, 600, 700, 800, 900, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000},    //  angle = 140°  à   149°
        { 500, 500, 500, 500, 500, 500, 600, 700, 800, 900, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000},    //  angle = 150°  à   159°
        { 500, 500, 500, 500, 500, 500, 600, 700, 800, 900, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000},    //  angle = 160°  à   169°
        { 500, 500, 500, 500, 500, 500, 600, 700, 800, 900, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000},    //  angle = 170°  à   179°
        { 500, 500, 500, 500, 500, 500, 600, 700, 800, 900, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000},    //  angle = 180
        };
        ...
        private void frm_main_Load(object sender, EventArgs e)
        {
            ...
            //  {Lat=48,4419847890688, Lng=-2,07414954900742}
        ...
        private void btn_TRACK03_Click(object sender, EventArgs e)
        {
            //Load_Track(3);
            Grid.Rows.Clear();
            Grid.Rows.Add(1, "48.4420185961116", "-2.07421191036701", Navigateur.set_plot_speed.ToString(), true);
            Application.DoEvents();
            AfficheDistances();
            AfficheTrack();
        }
        ...
        private void btn_TRACK02_Click(object sender, EventArgs e)
        {
            //Load_Track(2);
            Grid.Rows.Clear();
            Grid.Rows.Add(1, "48.441949", "-2.074184", Navigateur.set_plot_speed.ToString(), true);
            Application.DoEvents();
            AfficheDistances();
            AfficheTrack();
        }
        ...
        private void btn_TRACK01_Click(object sender, EventArgs e)
        {
            //Load_Track(1);
            Grid.Rows.Clear();
            Grid.Rows.Add(1, "48.4419634372407", "-2.07405567169189", Navigateur.set_plot_speed.ToString(), true);
            Application.DoEvents();
            AfficheDistances();
            AfficheTrack();
        }
        ...
        private void btn_TRACK04_Click(object sender, EventArgs e)
        {
            ...
            Grid.Rows.Clear();
             for (int i = 0; i < 10; i++)
            {
                Grid.Rows.Add(i, "48.441949", "-2.074184", Navigateur.set_plot_speed.ToString(), true);
                Grid.Rows.Add(i, "48.4420185961116", "-2.07421191036701", Navigateur.set_plot_speed.ToString(), true);
                Grid.Rows.Add(i, "48.441949", "-2.074184", Navigateur.set_plot_speed.ToString(), true);
                Grid.Rows.Add(i, "48.4419634372407", "-2.07405567169189", Navigateur.set_plot_speed.ToString(), true);
            }
            Application.DoEvents();
            AfficheDistances();
            AfficheTrack();
