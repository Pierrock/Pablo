...
namespace PABLO
{
    class cls_AttitudeIndicator : InstrumentControl
    {
        #region Fields
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(PABLO.Properties.Resources.Horizon_Background);
        Bitmap bmpBoule = new Bitmap(PABLO.Properties.Resources.Horizon_GroundSky);
        Bitmap bmpAvion = new Bitmap(PABLO.Properties.Resources.Maquette_Avion);
