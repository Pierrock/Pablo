...
namespace PABLO
{
    class cls_AirSpeedIndicator : InstrumentControl
    {
         #region Fields
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(PABLO.Properties.Resources.AirSpeedIndicator_Background);
        Bitmap bmpNeedle = new Bitmap(PABLO.Properties.Resources.AirSpeedNeedle);
